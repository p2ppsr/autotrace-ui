            ...
            <Container maxWidth='lg'>
                <Grid container justify='center' direction='column'>
                    ...
                    <Grid item container spacing={3} align='center' direction='column' className={classes.inputField}>
                        <Grid item>
                            <TextField id='transferVinNumber' label='VIN Number' variant='filled' color='primary'/>
                        </Grid>
                        <Grid item>
                            <TextField id='transferNewOwner' label='New Owner' variant='filled' color='primary'/>
                        </Grid>
                    </Grid>
                    <Grid item align='center' className={classes.button}>
                        <Button variant='contained' color='secondary' id='transfer'>Transfer</Button>
                    </Grid>
                </Grid>
            </Container>
        </div>
